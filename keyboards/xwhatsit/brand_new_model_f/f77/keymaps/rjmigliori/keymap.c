...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ansi_regular_shift_regular_backspace(
        TD(EB), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC,            KC_PSCR,   KC_SLCK,   KC_PAUS,
        ...
        KC_LCTRL, KC_LGUI, KC_LALT,                      KC_SPC,                  KC_RALT, KC_LGUI, MO(_FN),     KC_LEFT, KC_DOWN, KC_RIGHT
    ),
...
//Reset on R
//Thank fuck magic reset through LShift+RShift+B
//Jfc 
