...
#define DESCRIPTION QMK firmware for the modelfkeyboards.com reproduction of the IBM Model F keyboards using the through hole universal xwhatsit controller PCB
