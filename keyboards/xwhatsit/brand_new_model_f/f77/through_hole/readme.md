# xwhatsit/brand_new_model_f/f77/through_hole

![xwhatsit/brand_new_model_f/f77/through_hole](https://www.modelfkeyboards.com/wp-content/uploads/2019/11/F62-F77-new.jpg)

A short description of the keyboard/project

* Keyboard Maintainer: [Purdea Andrei](https://github.com/purdeaandrei)
* Hardware Supported: Supports the brand new Model F reproductions from https://www.modelfkeyboards.com/, using the (non-default) through hole universal xwhatsit controller PCB.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make xwhatsit/brand_new_model_f/f77/through_hole:default
